    ...
    if args.task!=None:
        ...
        for task in range(numtasks):
            if args.gc==True:
                ...
                sampled_indices=negs_dinucmatched_samp(data.iloc[:,task],freqs,args.ratio_neg_to_pos[task],args.outf+'.'+str(task), random_seed=args.seed)
...
def get_dinuc_mat(args):
    ...
    all_dinucs_n = all_dinucs + ['AN', 'CN', 'GN', 'TN', 'NA', 'NC', 'NG', 'NT', 'NN']
